...
const studies: Study[] = [
  {
    ...
    qualityScore: 8.5,
    abstract:
      "Badanie oceniało wpływ suplementacji Lion's Mane na funkcje poznawcze u zdrowych dorosłych. Uczestnicy otrzymywali 1000mg ekstraktu dziennie przez 16 tygodni. Wyniki pokazały znaczącą poprawę w testach pamięci roboczej, koncentracji i szybkości przetwarzania informacji.",
    keyFindings: [
    ...
    practicalImplications:
      "Suplementacja Lion's Mane może być bezpieczną opcją dla osób chcących poprawić funkcje poznawcze."
  },
  {
    ...
    qualityScore: 9.2,
    abstract:
      'Badanie kliniczne oceniające wpływ standaryzowanego ekstraktu Bacopa monnieri na pamięć u zdrowych dorosłych. Uczestnicy otrzymywali 300mg ekstraktu dziennie przez 12 tygodni. Obserwowano znaczącą poprawę w testach pamięci słownej i wizualnej.',
    keyFindings: [
    ...
    practicalImplications:
      'Bacopa wymaga długoterminowej suplementacji dla optymalnych efektów na pamięć.'
  },
  {
    ...
    qualityScore: 9.0,
    abstract:
      'Meta-analiza 11 randomizowanych badań kontrolowanych oceniających wpływ Rhodiola rosea na zmęczenie związane ze stresem i wydajność kognitywną. Analiza obejmowała 412 uczestników z różnych badań.',
    keyFindings: [
    ...
    practicalImplications:
      'Rhodiola jest skutecznym adaptogenem dla osób doświadczających chronicznego stresu.'
  },
  {
    ...
    qualityScore: 8.8,
    abstract:
      'Kompleksowy przegląd badań nad wpływem kwasów omega-3 na zdrowie mózgu. Analiza obejmowała 23 wysokiej jakości badania kliniczne z łączną liczbą 2847 uczestników.',
    keyFindings: [
    ...
    practicalImplications:
      'Omega-3 powinny być podstawą każdego protokołu neuroprotekcyjnego.'
  },
  {
    ...
    qualityScore: 8.7,
    abstract:
      'Badanie oceniające wpływ standaryzowanego ekstraktu ashwagandha (KSM-66) na poziom kortyzolu i stres u zdrowych dorosłych. Uczestnicy otrzymywali 600mg dziennie przez 8 tygodni.',
    keyFindings: [
    ...
    practicalImplications:
      'Ashwagandha KSM-66 jest skutecznym adaptogenem dla redukcji stresu chronicznego.'
  },
  {
    ...
    qualityScore: 7.5,
    abstract:
      'Meta-analiza 6 randomizowanych badań kontrolowanych oceniających wpływ kreatyny na funkcje poznawcze u zdrowych dorosłych. Łączna liczba uczestników wyniosła 281.',
    keyFindings: [
    ...
    practicalImplications:
      'Kreatyna może być pomocna szczególnie w sytuacjach wymagających szybkiego myślenia.'
  }
]
...
export default function ResearchPage() {
  ...
  const filteredStudies = studies.filter((study) => {
    const categoryMatch =
      selectedCategory === 'Wszystkie' || study.category === selectedCategory
    const typeMatch =
      selectedStudyType === 'Wszystkie' || study.studyType === selectedStudyType
    const supplementMatch =
      selectedSupplement === 'Wszystkie' || study.supplement === selectedSupplement
    const searchMatch =
      searchTerm === '' ||
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center">
          <h1 className="mb-4 text-4xl font-bold text-gray-900">Baza Badań Naukowych</h1>
          <p className="mx-auto max-w-3xl text-xl text-gray-600">
            Najnowsze badania kliniczne i meta-analizy dotyczące suplementów nootropowych
            i ich wpływu na zdrowie mózgu
          </p>
        </div>
              ...
              <CardHeader>
                <div className="mb-2 flex items-start justify-between">
                  ...
                  <div className="ml-2 flex items-center">
                    <Star
                      className={`mr-1 h-4 w-4 ${getQualityColor(study.qualityScore)}`}
                    />
                    <span
                      className={`text-sm font-medium ${getQualityColor(study.qualityScore)}`}
                    >
                ...
                <div className="mb-2 flex flex-wrap gap-2">
                  ...
                  <Badge className={getSignificanceColor(study.significance)}>
                    {study.significance}
                  </Badge>
                </div>
        ...
        {selectedStudy && (
          ...
          >
            <div
              className="max-h-[90vh] w-full max-w-5xl overflow-y-auto rounded-lg bg-white"
              ...
              <div className="p-6">
                <div className="mb-6 flex items-start justify-between">
                  <div className="mr-4 flex-1">
                    ...
                    <p className="mb-2 text-gray-600">{selectedStudy.authors}</p>
                    ...
                    <div className="mb-4 flex flex-wrap gap-2">
                      ...
                      <Badge className={getSignificanceColor(selectedStudy.significance)}>
                        {selectedStudy.significance}
                      </Badge>
                      <Badge variant="outline">
                        Jakość: {selectedStudy.qualityScore}/10
                      </Badge>
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        window.open(`https://doi.org/${selectedStudy.doi}`, '_blank')
                      }
                    >
                ...
                <Card className="mt-6">
                  ...
                  <CardContent>
                    <p className="leading-relaxed text-gray-700">
                      {selectedStudy.practicalImplications}
                    </p>
                  </CardContent>
                </Card>

                <div className="mt-6 rounded-lg bg-blue-50 p-4">
                  <h3 className="mb-2 font-medium text-blue-900">Uwaga</h3>
                  <p className="text-sm text-blue-800">
                    Przedstawione badania mają charakter informacyjny i nie stanowią
                    porady medycznej. Przed rozpoczęciem suplementacji skonsultuj się z
