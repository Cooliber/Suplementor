...
const protocols: Protocol[] = [
  {
    ...
    description: 'Kompleksowy protokół łączący suplementację z technikami behawioralnymi dla maksymalnej koncentracji.',
    ...
    scientificBasis: 'Protokół oparty na badaniach nad neuroplastycznością, modulacją acetylocholiny i optymalizacją fal mózgowych gamma.',
    successRate: 87,
    userRating: 4.6,
    reviews: 234
  },
  {
    ...
    difficulty: 'beginner',
    description: 'Holistyczne podejście do zarządzania stresem z wykorzystaniem adaptogenów i technik relaksacyjnych.',
    ...
    scientificBasis: 'Oparty na badaniach nad osią HPA, działaniem adaptogenów i wpływem technik mindfulness na redukcję kortyzolu.',
    successRate: 92,
    userRating: 4.8,
    reviews: 456
  },
  {
    ...
    difficulty: 'beginner',
    description: 'Kompleksowy protokół dla osób z problemami z zasypianiem i jakością snu.',
    targetAudience: ['Osoby z bezsennością', 'Pracownicy zmianowi', 'Jet lag', 'Stres chroniczny'],
    expectedResults: [
    ...
    scientificBasis: 'Oparty na chronobiologii, badaniach nad melatoniną i wpływem środowiska na jakość snu.',
    successRate: 89,
    userRating: 4.7,
    reviews: 378
  }
...
const optimizationTips: OptimizationTip[] = [
  {
    ...
    description: 'Dostosuj timing suplementacji do swojego naturalnego rytmu dobowego. Skowronki powinny przyjmować nootropiki wcześniej, sowy - później.',
    impact: 'high',
    difficulty: 'easy',
  ...
  },
  {
    ...
    description: 'Stosuj adaptogeny w cyklach 6-8 tygodni z 2-tygodniowymi przerwami, aby uniknąć tolerancji i utrzymać skuteczność.',
    impact: 'medium',
    difficulty: 'moderate',
  ...
  },
  {
    ...
    description: 'Łącz L-teaninę z kofeiną w stosunku 2:1 dla optymalnej koncentracji bez jittery. Dodaj magnez dla lepszej absorpcji.',
    impact: 'high',
    difficulty: 'easy',
  ...
  },
  {
    ...
    description: 'Monitoruj HRV (Heart Rate Variability) i temperaturę ciała rano, aby ocenić skuteczność protokołów antystresowych.',
    impact: 'medium',
    difficulty: 'moderate',
  ...
  },
  {
    ...
    description: 'Wykonaj testy polimorfizmów COMT, MTHFR i CYP1A2, aby spersonalizować dawkowanie kofeiny, folianów i dopaminy.',
    impact: 'high',
    difficulty: 'hard',
  ...
  },
  {
    ...
    description: 'Używaj światła 10,000 lux rano przez 30 min i blokuj światło niebieskie 2h przed snem dla optymalnej melatoniny.',
    impact: 'high',
    difficulty: 'easy',
    timeframe: '1-2 tygodnie'
  },
  {
    ...
    description: 'Przyjmuj suplementy lipofilne (omega-3, witaminy A,D,E,K) z tłuszczami, a hydrofilne (witaminy B, C) na czczo.',
    impact: 'medium',
    difficulty: 'easy',
    timeframe: 'Natychmiastowy'
  },
  {
    ...
    description: 'Wprowadź 1 dzień w tygodniu bez suplementów nootropowych, aby zresetować receptory i ocenić bazową funkcję kognitywną.',
    impact: 'medium',
    difficulty: 'moderate',
    timeframe: '1 tydzień'
  }
...
export default function ProtocolGuides({ selectedCategory }: ProtocolGuidesProps) {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'steps' | 'optimization'>('overview');
  ...
  const filteredProtocols = protocols.filter(protocol => {
    ...
    const difficultyMatch = filterDifficulty === 'all' || protocol.difficulty === filterDifficulty;
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'stress': return <Shield className="h-5 w-5" />;
  ...
  if (selectedProtocol) {
    return (
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <div className="flex items-center space-x-4 text-sm">
                  <span className={`px-2 py-1 rounded ${getDifficultyColor(selectedProtocol.difficulty)}`}>
                    {selectedProtocol.difficulty === 'beginner' ? 'Początkujący' :
                     selectedProtocol.difficulty === 'intermediate' ? 'Średniozaawansowany' : 'Zaawansowany'}
                  </span>
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="font-semibold text-gray-900 mb-4">Cel protokołu</h3>
                <p className="text-gray-700 mb-4">{selectedProtocol.goal}</p>
                ...
                <h4 className="font-medium text-gray-900 mb-2">Oczekiwane rezultaty:</h4>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="font-semibold text-gray-900 mb-4">Podstawa naukowa</h3>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="font-semibold text-gray-900 mb-4">Suplementy</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="font-semibold text-gray-900 mb-4">Styl życia</h3>
                <ul className="space-y-2">
        ...
        {activeTab === 'steps' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h3 className="font-semibold text-gray-900 mb-6">Kroki protokołu</h3>
            <div className="space-y-4">
              {selectedProtocol.steps.map((step, index) => (
                <div key={step.id} className={`border rounded-lg p-4 ${step.critical ? 'border-red-200 bg-red-50' : 'border-gray-200'}`}>
        ...
        {activeTab === 'optimization' && (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold text-gray-900 mb-4">Monitorowanie postępów</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold text-gray-900 mb-4">Wskazówki optymalizacyjne</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold text-gray-900 mb-4">Zaawansowane optymalizacje</h3>
              <div className="grid gap-4">
                {optimizationTips.filter(tip => 
                  (selectedProtocol.category === 'cognitive' && ['Timing', 'Synergizm', 'Personalizacja'].includes(tip.category)) ||
                  (selectedProtocol.category === 'stress' && ['Monitoring', 'Recovery', 'Lifestyle'].includes(tip.category)) ||
                  (selectedProtocol.category === 'sleep' && ['Lifestyle', 'Timing', 'Absorpcja'].includes(tip.category))
                ).map(tip => (
                  <div key={tip.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-medium text-gray-900">{tip.title}</h4>
                      <div className="flex space-x-2">
                        <span className={`px-2 py-1 rounded text-xs ${getImpactColor(tip.impact)}`}>
                          {tip.impact === 'high' ? 'Wysoki' : tip.impact === 'medium' ? 'Średni' : 'Niski'} wpływ
                        </span>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredProtocols.map(protocol => (
          <div key={protocol.id} className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center">
                  {getCategoryIcon(protocol.category)}
                  <span className="ml-2 text-sm text-gray-600 capitalize">
                    {protocol.category === 'cognitive' ? 'Kognitywne' :
                     protocol.category === 'stress' ? 'Stres' :
                     protocol.category === 'sleep' ? 'Sen' :
                     protocol.category === 'energy' ? 'Energia' : 'Regeneracja'}
                  </span>
                </div>
                <button
              ...
              <div className="flex items-center justify-between mb-4">
                <span className={`px-2 py-1 rounded text-xs ${getDifficultyColor(protocol.difficulty)}`}>
                  {protocol.difficulty === 'beginner' ? 'Początkujący' :
                   protocol.difficulty === 'intermediate' ? 'Średni' : 'Zaawansowany'}
                </span>
                <div className="flex items-center text-sm text-gray-600">
                  <Clock className="h-4 w-4 mr-1" />
                  {protocol.duration}
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <span className="text-xs text-gray-500 ml-1">({protocol.reviews})</span>
                </div>
