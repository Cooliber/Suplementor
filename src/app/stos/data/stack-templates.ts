...
export const stackTemplates: NeuroStack[] = [
  {
    ...
    polishDescription: "Łagodne wprowadzenie do nootropików z minimalnymi skutkami ubocznymi",
    ...
    polishBenefits: ["Poprawione skupienie", "Zredukowany niepokój", "Lepszy nastrój", "Łagodne wprowadzenie"],
    considerations: ["Start with lower doses", "Monitor effects", "Combine with caffeine"],
    polishConsiderations: ["Zacznij od niższych dawek", "Monitoruj efekty", "Połącz z kofeiną"]
  },
  {
    id: "advanced-focus",
    ...
    createdAt: new Date(),
    benefits: ["Enhanced memory", "Improved focus", "Better motivation", "Cognitive clarity"],
    polishBenefits: ["Wzmocniona pamięć", "Poprawione skupienie", "Lepsza motywacja", "Jasność poznawcza"],
    considerations: ["Monitor for overstimulation", "Cycle off every 8 weeks", "Stay hydrated"],
    polishConsiderations: ["Monitoruj przedstymulowanie", "Zrób przerwę co 8 tygodni", "Pij dużo wody"]
  },
  {
    ...
    polishDescription: "Adaptogenna mieszanka do zarządzania stresem i równowagi emocjonalnej",
    ...
    createdAt: new Date(),
    benefits: ["Reduced cortisol", "Better stress response", "Improved sleep", "Emotional balance"],
    polishBenefits: ["Zredukowany kortyzol", "Lepsza odpowiedź na stres", "Poprawiony sen", "Równowaga emocjonalna"],
    considerations: ["May take 2-4 weeks to notice effects", "Monitor thyroid function", "Cycle rhodiola"],
    polishConsiderations: ["Efekty mogą wymagać 2-4 tygodni", "Monitoruj funkcję tarczycy", "Cyklicznie stosuj różeniec"]
  },
  {
    ...
    polishDescription: "Stack skoncentrowany na neuroplastyczności dla formowania i zachowania pamięci",
    ...
    createdAt: new Date(),
    benefits: ["Enhanced memory consolidation", "Improved recall", "Neuroprotection", "Long-term benefits"],
    polishBenefits: ["Wzmocniona konsolidacja pamięci", "Poprawione przypominanie", "Neuroprotekcja", "Korzyści długoterminowe"],
    considerations: ["Requires consistent use", "Effects build over time", "Take with food"],
    polishConsiderations: ["Wymaga systematycznego stosowania", "Efekty budują się z czasem", "Przyjmuj z posiłkiem"]
  },
  {
    ...
    polishDescription: "Naturalne wsparcie snu z korzyściami relaksacyjnymi i regeneracyjnymi",
    ...
    createdAt: new Date(),
    benefits: ["Faster sleep onset", "Deeper sleep", "Better recovery", "Morning refreshment"],
    polishBenefits: ["Szybsze zaśnięcie", "Głębszy sen", "Lepsza regeneracja", "Poranne odświeżenie"],
    considerations: ["Start 2-3 hours before bed", "Consistent timing", "Dark room"],
    polishConsiderations: ["Zacznij 2-3h przed snem", "Systematyczne czasowanie", "Ciemny pokój"]
  },
  {
    id: "neuroprotection",
    name: "Neuroprotection Stack",
    polishName: "Stack Neuroprotekcyjny",
    description: "Comprehensive neuroprotection with antioxidants and anti-inflammatories",
    ...
    createdAt: new Date(),
    benefits: ["Neuroprotection", "Anti-aging", "Cognitive preservation", "Long-term health"],
    polishBenefits: ["Neuroprotekcja", "Przeciwstarzeniowe", "Zachowanie funkcji poznawczych", "Długoterminowe zdrowie"],
    considerations: ["Long-term commitment", "Consistent use", "Healthy lifestyle"],
    polishConsiderations: ["Długoterminowe zaangażowanie", "Systematyczne stosowanie", "Zdrowy styl życia"]
  }
];

export const getTemplateById = (id: string): NeuroStack | undefined => stackTemplates.find(template => template.id === id);

export const getTemplatesByDifficulty = (difficulty: string): NeuroStack[] => stackTemplates.filter(template => template.difficulty === difficulty);

export const getTemplatesByTag = (tag: string): NeuroStack[] => stackTemplates.filter(template => 
    template.tags.includes(tag) || template.polishTags.includes(tag)
  );

export const getRecommendedTemplates = (experience: string, goals: string[]): NeuroStack[] => {
