...
export const supplementsDatabase: readonly Supplement[] = [
  {
    ...
    notes: "Esencjalny aminokwas niezbędny do syntezy białek, wzrostu i regeneracji tkanek. Wspiera zdrowie kości, stawów i mięśni.",
    sideEffects: [
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Potężny nootropowy grzyb stymulujący NGF (Nerve Growth Factor), wspierający neurogenezę i plastyczność mózgu. Wykazuje działanie neuroprotekcyjne i poprawia funkcje poznawcze.",
    sideEffects: ["Rozpocząć od niższej dawki", "Monitorować reakcje alergiczne"],
    contraindications: ["Alergia na grzyby", "Autoimmunologiczne choroby (konsultacja lekarska)"],
    interactions: [
      {
    ...
    researchLinks: ["https://pubmed.ncbi.nlm.nih.gov/24266378/", "https://pubmed.ncbi.nlm.nih.gov/20834180/"]
  },
  {
    ...
    category: "health",
    startDate: "2024-01-01",
    notes: "Docosahexaenoic acid (DHA) - główny składnik neuronów i mózgu. Wersja wegańska z alg.",
    sideEffects: ["Przechowywać w chłodnym miejscu", "Chronić przed światłem"],
    contraindications: ["Alergia na ryby (dla wersji rybnej)", "Zaburzenia krzepnięcia krwi"],
    interactions: [
      {
        supplementId: "blood-thinners",
        severity: "medium",
  ...
  },
  {
    ...
    category: "energy",
    startDate: "2024-01-01",
    notes: "Silny ekstrakt z Eria jarensis wspierający wydolność fizyczną i psychiczną. Zwiększa produkcję dopaminy.",
    sideEffects: ["Nie stosować wieczorem", "Może wpływać na sen", "Konsultacja z lekarzem"],
    contraindications: [],
    interactions: [],
    researchLinks: []
  },
  {
    ...
    category: "mood",
    startDate: "2024-01-01",
    notes: "Wielka para adaptogenów z medycyny chińskiej. Wspiera odporność, zmniejsza stres i poprawia ogólną kondycję.",
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Chińska specjalność dla ciała i mózgu. Tradycyjny adaptogen wspierający witalność i funkcje poznawcze.",
  ...
  },
  {
    ...
    category: "health",
    startDate: "2024-01-01",
    notes: "Potężny flawonoid przeciwzapalny wspierający odporność. Naturalny antyoksydant z Sophora japonica.",
    sideEffects: ["Może powodować łagodne problemy trawienne", "Konsultacja z lekarzem przy chorobach nerek"],
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Prekursor acetylocholiny, zwiększa poziom choliny w mózgu, poprawiając pamięć i uczenie się. Synergia z racetamami (PubMed: 12637119).",
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Dostarcza choliny i urydyny, wspiera syntezę fosfatydylocholiny w błonach komórkowych. Badania pokazują efekty w udarach (PubMed: 10974208). Synergia z DHA.",
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Kluczowy składnik błon komórkowych, redukuje kortyzol, poprawia pamięć. Synergia z Omega-3 (PubMed: 18456273).",
    sideEffects: ["Droga"],
  ...
  },
  {
    ...
    category: "health",
    startDate: "2024-01-01",
    notes: "EPA i DHA wspierają zdrowie mózgu, redukują zapalenie. Synergia z kurkuminą (PubMed: 25694085).",
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Poprawia krążenie mózgowe, działa antyoksydacyjnie. Synergia z winpocetyną (PubMed: 11588457).",
    sideEffects: ["Rozrzedza krew"],
  ...
  },
  {
    ...
    category: "cognitive",
    startDate: "2024-01-01",
    notes: "Adaptogen zwiększający energię, poprawiający funkcje poznawcze. Synergia z ginkgo (PubMed: 20737519).",
    sideEffects: [],
