...
export class APIPerformanceTracker {
  ...
  private endpoints: Map<string, { count: number; totalTime: number; errors: number }> =
    new Map()
...
export class DatabasePerformanceTracker {
  ...
  private queries: Map<string, { count: number; totalTime: number; errors: number }> =
    new Map()
...
export class ExternalServiceTracker {
  ...
  private services: Map<string, { count: number; totalTime: number; errors: number }> =
    new Map()
