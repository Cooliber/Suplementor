...
import { Activity, Brain, Zap, Heart, TrendingUp, TrendingDown, AlertTriangle, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {realTimeData && [
          { key: 'cognitive', label: 'Funkcje poznawcze', icon: Brain, value: realTimeData.cognitive },
          { key: 'energy', label: 'Energia', icon: Zap, value: realTimeData.energy },
          { key: 'focus', label: 'Koncentracja', icon: Activity, value: realTimeData.focus },
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {(trends[key as keyof typeof trends] ?? 0) && getTrendIcon(trends[key as keyof typeof trends] ?? 0)}
                </div>
              </div>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={historicalData}>
                  ...
                  <YAxis domain={[0, 100]} />
                  <Tooltip />
                  <Line type="monotone" dataKey="cognitive" stroke="#3b82f6" strokeWidth={2} name="Funkcje poznawcze" />
                  ...
                  <Line type="monotone" dataKey="focus" stroke="#8b5cf6" strokeWidth={2} name="Koncentracja" />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{Math.round(biometrics.heartRate)} bpm</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{biometrics.steps.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between">
