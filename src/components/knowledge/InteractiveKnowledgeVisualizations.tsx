...
export function InteractiveKnowledgeVisualizations() {
  ...
  const filteredNodes = useMemo(() => {
    return knowledgeNodes.filter((node) => {
      ...
      const importanceMatch =
        (node?.importance ?? 0) >= (importanceThreshold?.[0] ?? 0) &&
        (node?.importance ?? 0) <= (importanceThreshold?.[1] ?? 100)
  ...
  const networkMetrics = useMemo((): NetworkMetrics => {
    ...
    const density =
      totalNodes > 1 ? (totalConnections * 2) / (totalNodes * (totalNodes - 1)) : 0
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Neuroprzekaźniki">
                            Neuroprzekaźniki
                          </SelectItem>
                          <SelectItem value="Funkcje poznawcze">
                            Funkcje poznawcze
                          </SelectItem>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <span className="text-sm">
                            {selectedNodeData?.importance ?? 0}/100
                          </span>
                        </div>
                        <div>
          ...
          <TabsContent value="timeline">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Kluczowe wydarzenia w rozwoju nootropików
                </CardDescription>
              </CardHeader>
              <CardContent>
                        ...
                        <div className="w-4 flex-shrink-0">
                          <div
                            className={`h-4 w-4 rounded-full bg-gradient-to-r ${
                              (event?.importance ?? 0) > 90
                                ? 'from-red-500 to-red-600'
                                : (event?.importance ?? 0) > 80
                                  ? 'from-orange-500 to-orange-600'
                                  : 'from-yellow-500 to-yellow-600'
                            }`}
                          />
                        </div>
                        <div className="flex-1 border-l-2 pb-6 pl-4">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {networkMetrics.averageDegree.toFixed(2)}
                      </span>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {networkMetrics.density.toFixed(2)}
                      </span>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div>
                    <h3 className="mb-4 font-medium">Wybierz koncept do eksploracji</h3>
                  ...
                  {selectedNodeData && (
                    <div>
                      <h3 className="mb-4 font-medium">Powiązania</h3>
                      <div className="space-y-4">
                        <div>
                        ...
                        <div>
                          <h4 className="mb-2 text-sm font-medium">Podobne koncepty</h4>
