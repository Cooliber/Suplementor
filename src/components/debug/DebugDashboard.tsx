...
const DebugDashboard: React.FC = () => {
  ...
  const performanceMetrics = useMemo(() => {
    ...
    const avgDuration = perfEvents.reduce((sum, e) => sum + (e.data?.duration || 0), 0) / perfEvents.length || 0;
    ...
    return {
      ...
      supplementInteractions: events.filter(e => e.category === DebugCategory.SUPPLEMENT).length,
    };
  }, [events]);
  ...
  return (
    <>
      ...
      {/* Debug dashboard */}
      {isVisible && (
        <div className="fixed inset-4 bg-background border rounded-lg shadow-xl z-40 flex flex-col">
                    ...
                    <div className="flex items-center gap-4 p-3 bg-muted rounded-lg">
                      ...
                      <Select value={selectedLevel.toString()} onValueChange={(value) => setSelectedLevel(value === 'all' ? 'all' : parseInt(value))}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={DebugLevel.WARN.toString()}>Warning</SelectItem>
                      ...
                      <Select value={selectedCategory} onValueChange={(value) => setSelectedCategory(value === 'all' ? 'all' : value as DebugCategory)}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold mt-1">{performanceMetrics.totalEvents}</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold mt-1 text-red-600">{performanceMetrics.errorCount}</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold mt-1">{performanceMetrics.avgPerformance.toFixed(1)}ms</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold mt-1">{performanceMetrics.supplementInteractions}</p>
                      </CardContent>
                    </Card>
                  </div>
